...
const file_sub_proto_rawDesc = "" +
	"\n" +
	"\tsub.proto\x12\x0ecalculator.sub\".\n" +
	...
	"\n" +
	"SubService\x12N\n" +
	"\aCompute\x12 .calculator.sub.OperationRequest\x1a!.calculator.sub.OperationResponseB!Z\x1fnotask/op-coordinator/api/subpbb\x06proto3"
...
var file_sub_proto_goTypes = []any{
	(*OperationRequest)(nil),  // 0: calculator.sub.OperationRequest
	(*OperationResponse)(nil), // 1: calculator.sub.OperationResponse
}
var file_sub_proto_depIdxs = []int32{
	0, // 0: calculator.sub.SubService.Compute:input_type -> calculator.sub.OperationRequest
	1, // 1: calculator.sub.SubService.Compute:output_type -> calculator.sub.OperationResponse
