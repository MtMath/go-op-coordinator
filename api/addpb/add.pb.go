...
const file_add_proto_rawDesc = "" +
	"\n" +
	"\tadd.proto\x12\x0ecalculator.add\".\n" +
	...
	"\n" +
	"AddService\x12N\n" +
	"\aCompute\x12 .calculator.add.OperationRequest\x1a!.calculator.add.OperationResponseB!Z\x1fnotask/op-coordinator/api/addpbb\x06proto3"
...
var file_add_proto_goTypes = []any{
	(*OperationRequest)(nil),  // 0: calculator.add.OperationRequest
	(*OperationResponse)(nil), // 1: calculator.add.OperationResponse
}
var file_add_proto_depIdxs = []int32{
	0, // 0: calculator.add.AddService.Compute:input_type -> calculator.add.OperationRequest
	1, // 1: calculator.add.AddService.Compute:output_type -> calculator.add.OperationResponse
