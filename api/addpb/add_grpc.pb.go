...
const (
	AddService_Compute_FullMethodName = "/calculator.add.AddService/Compute"
)
...
func (c *addServiceClient) Compute(ctx context.Context, in *OperationRequest, opts ...grpc.CallOption) (*OperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OperationResponse)
	err := c.cc.Invoke(ctx, AddService_Compute_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAddServiceServer) Compute(context.Context, *OperationRequest) (*OperationResponse, error) {
...
func _AddService_Compute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddService_Compute_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Compute(ctx, req.(*OperationRequest))
	}
...
var AddService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calculator.add.AddService",
